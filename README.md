...
Indeed! The MK III isn't just a cheat device but also an excellent region adapter. Apparently, it's the only one that can play SMRPG (or Super Mario RPG) on European consoles! I was also amazed to find out that it can convert Game Genie codes! But there was more: it was supposed to have a built-in code database. Could that really be?
...
- [Manual (German, revised V1.1a)](manual_de.md)
- [Manual (English, translation V1.4a)](manual_en.md)
...
See a [list of all includes games](./code-database.md).
